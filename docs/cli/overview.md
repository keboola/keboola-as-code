...
- Bidirectional synchronization of a local directory and [Keboola Connection](https://www.keboola.com/product/overview) project:
    ...
    - Calls [Keboola Storage API](https://help.keboola.com/storage/api/).
...
The installation, usage, and complete list of available commands are in the [user documentation](../user-docs/README.md) in this repository. 
