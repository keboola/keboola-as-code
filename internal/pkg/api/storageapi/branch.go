...
func (a *Api) GetBranchRequest(branchId model.BranchId) *client2.Request {
	branch := &model.Branch{}
	return a.
...
func (a *Api) CreateBranchRequest(branch *model.Branch) *client2.Request {
	job := &model.Job{}
	// Id is autogenerated
	if branch.Id != 0 {
	...
	request.OnSuccess(waitForJob(a, request, job, func(response *client2.Response) {
...
func (a *Api) UpdateBranchRequest(branch *model.Branch, changed model.ChangedFields) *client2.Request {
	// Id is required
	if branch.Id == 0 {
...
func (a *Api) ListBranchesRequest() *client2.Request {
...
func (a *Api) DeleteBranchRequest(key model.BranchKey) *client2.Request {
	job := &model.Job{}
	request := a.
