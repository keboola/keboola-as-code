...
func TestTemplateIdsDialog_DefaultValue(t *testing.T) {
	...
	configs := []*model.ConfigWithRows{
		{
			Config: &model.Config{
				ConfigKey: model.ConfigKey{BranchId: 1, ComponentId: "foo.bar", ConfigId: "123"},
				Name:      "My Config 1",
			},
		},
		{
			Config: &model.Config{
				ConfigKey: model.ConfigKey{BranchId: 1, ComponentId: "foo.bar", ConfigId: "456"},
				Name:      "My Config 2",
			},
			Rows: []*model.ConfigRow{
				{
					ConfigRowKey: model.ConfigRowKey{BranchId: 1, ComponentId: "foo.bar", ConfigId: "456", ConfigRowId: "1"},
					Name:         "My Row",
				},
				{
					ConfigRowKey: model.ConfigRowKey{BranchId: 1, ComponentId: "foo.bar", ConfigId: "456", ConfigRowId: "2"},
					Name:         "My Row",
				},
				{
					ConfigRowKey: model.ConfigRowKey{BranchId: 1, ComponentId: "foo.bar", ConfigId: "456", ConfigRowId: "3"},
					Name:         "#$%^_",
				},
			},
		},
