...
type FileLoader interface {
	...
	ReadFileContentTo(file *FileDef, target any, structTag string) (*RawFile, bool, error)
	ReadJSONFile(file *FileDef) (*JSONFile, error)
	ReadJSONFileTo(file *FileDef, target any) (*RawFile, error)
	ReadJSONFieldsTo(file *FileDef, target any, structTag string) (*JSONFile, bool, error)
	ReadJSONMapTo(file *FileDef, target any, structTag string) (*JSONFile, bool, error)
	ReadYamlFile(file *FileDef) (*YamlFile, error)
	ReadYamlFileTo(file *FileDef, target any) (*RawFile, error)
	ReadYamlFieldsTo(file *FileDef, target any, structTag string) (*YamlFile, bool, error)
	ReadYamlMapTo(file *FileDef, target any, structTag string) (*YamlFile, bool, error)
	ReadJsonnetFile(file *FileDef) (*JsonnetFile, error)
	ReadJsonnetFileTo(file *FileDef, target any) (*JsonnetFile, error)
