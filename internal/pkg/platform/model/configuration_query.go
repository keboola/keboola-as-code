...
func (cq *ConfigurationQuery) FirstIDX(ctx context.Context) key.ConfigurationKey {
...
func (cq *ConfigurationQuery) OnlyIDX(ctx context.Context) key.ConfigurationKey {
...
func (cq *ConfigurationQuery) IDsX(ctx context.Context) []key.ConfigurationKey {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *ConfigurationQuery) loadParent(ctx context.Context, query *BranchQuery, nodes []*Configuration, init func(*Configuration), assign func(*Configuration, *Branch)) error {
