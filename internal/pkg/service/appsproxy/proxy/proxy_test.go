...
func registerDefaultK8sApps(t *testing.T, apps []api.AppConfig, fakeClient *k8sfake.FakeDynamicClient, watcher *k8sapp.StateWatcher, serviceRef string) {
	t.Helper()
		...
		obj := &unstructured.Unstructured{
			Object: map[string]any{
				...
				"status": map[string]any{
					...
					"appsProxyServiceRef": serviceRef,
				},
			},
		}
