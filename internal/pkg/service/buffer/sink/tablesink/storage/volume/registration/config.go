...
type Config struct {
	...
	TTLSeconds int `json:"registrationTimeToLive" configKey:"registrationTTL" configUsage:"Number of seconds after the volume registration expires if the node is not available." validate:"required,min=1,max=60"`
}
