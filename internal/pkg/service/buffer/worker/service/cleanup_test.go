...
{"level":"info","message":"started task","component":"task","prefix":"[_system_/tasks.cleanup/%s]"}
{"level":"debug","message":"lock acquired \"runtime/lock/task/tasks.cleanup\"","component":"task","prefix":"[_system_/tasks.cleanup/%s]"}
{"level":"info","message":"deleted \"0\" tasks","component":"task","prefix":"[_system_/tasks.cleanup/%s]"}
{"level":"info","message":"task succeeded (0s): deleted \"0\" tasks","component":"task","prefix":"[_system_/tasks.cleanup/%s]"}
{"level":"debug","message":"lock released \"runtime/lock/task/tasks.cleanup\"","component":"task","prefix":"[_system_/tasks.cleanup/%s]"}
...
{"level":"info","message":"deleted \"1\" files, \"1\" slices, \"0\" records","component":"task","prefix":"[1000/github/receiver.cleanup/%s]"}
