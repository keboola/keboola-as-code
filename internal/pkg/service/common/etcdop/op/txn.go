...
type txnInterface interface {
	...
	txnInvokeProcessors(ctx context.Context, core *txnResultCore) error
}
...
func (v *TxnOp[R]) txnInvokeProcessors(ctx context.Context, core *txnResultCore) error {
	txnResult := newTxnResult(core, v.result)
