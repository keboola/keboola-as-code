...
func TestApdex(t *testing.T) {
	...
	for _, tc := range cases {
		...
		assert.InEpsilon(t, tc.ExpectedApdexT500, t500Data.Value, float64(countData.Value))
		assert.InEpsilon(t, tc.ExpectedApdexT1000, t1000Data.Value, float64(countData.Value))
	}
}
