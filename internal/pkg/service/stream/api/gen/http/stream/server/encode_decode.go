...
func marshalStreamSourceToSourceResponseBody(v *stream.Source) *SourceResponseBody {
	...
	if v.Version != nil {
		res.Version = marshalStreamGetVersionToGetVersionResponseBody(v.Version)
	}
	if v.Deleted != nil {
...
// marshalStreamGetVersionToGetVersionResponseBody builds a value of type
// *GetVersionResponseBody from a value of type *stream.GetVersion.
func marshalStreamGetVersionToGetVersionResponseBody(v *stream.GetVersion) *GetVersionResponseBody {
	res := &GetVersionResponseBody{
		Number:      v.Number,
		Hash:        v.Hash,
