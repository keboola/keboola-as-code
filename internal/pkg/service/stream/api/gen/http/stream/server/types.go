...
type AggregateSourcesResponseBody struct {
	...
	BranchID  int                              `form:"branchId" json:"branchId" xml:"branchId"`
	Page      *PaginatedResponseResponseBody   `form:"page" json:"page" xml:"page"`
	Sources   []*AggregationSourceResponseBody `form:"sources" json:"sources" xml:"sources"`
}
...
// AggregationSourceResponseBody is used to define fields on response body
// types.
type AggregationSourceResponseBody struct {
	ProjectID int    `form:"projectId" json:"projectId" xml:"projectId"`
	BranchID  int    `form:"branchId" json:"branchId" xml:"branchId"`
	SourceID  string `form:"sourceId" json:"sourceId" xml:"sourceId"`
	Type      string `form:"type" json:"type" xml:"type"`
	...
	Deleted  *DeletedEntityResponseBody     `form:"deleted,omitempty" json:"deleted,omitempty" xml:"deleted,omitempty"`
	Disabled *DisabledEntityResponseBody    `form:"disabled,omitempty" json:"disabled,omitempty" xml:"disabled,omitempty"`
	Sinks    []*AggregationSinkResponseBody `form:"sinks" json:"sinks" xml:"sinks"`
}

// AggregationSinkResponseBody is used to define fields on response body types.
type AggregationSinkResponseBody struct {
	ProjectID int    `form:"projectId" json:"projectId" xml:"projectId"`
	BranchID  int    `form:"branchId" json:"branchId" xml:"branchId"`
	SourceID  string `form:"sourceId" json:"sourceId" xml:"sourceId"`
	SinkID    string `form:"sinkId" json:"sinkId" xml:"sinkId"`
	...
	Deleted     *DeletedEntityResponseBody         `form:"deleted,omitempty" json:"deleted,omitempty" xml:"deleted,omitempty"`
	Disabled    *DisabledEntityResponseBody        `form:"disabled,omitempty" json:"disabled,omitempty" xml:"disabled,omitempty"`
	Statistics  *AggregationStatisticsResponseBody `form:"statistics,omitempty" json:"statistics,omitempty" xml:"statistics,omitempty"`
}

// AggregationStatisticsResponseBody is used to define fields on response body
// types.
type AggregationStatisticsResponseBody struct {
	Total  *LevelResponseBody      `form:"total" json:"total" xml:"total"`
	Levels *LevelsResponseBody     `form:"levels" json:"levels" xml:"levels"`
	Files  []*SinkFileResponseBody `form:"files" json:"files" xml:"files"`
}
...
func NewAggregateSourcesResponseBody(res *stream.AggregationSourcesResult) *AggregateSourcesResponseBody {
	...
	if res.Sources != nil {
		body.Sources = make([]*AggregationSourceResponseBody, len(res.Sources))
		for i, val := range res.Sources {
			body.Sources[i] = marshalStreamAggregationSourceToAggregationSourceResponseBody(val)
		}
	} else {
		body.Sources = []*AggregationSourceResponseBody{}
	}
	return body
}
