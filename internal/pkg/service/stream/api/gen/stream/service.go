...
type Service interface {
	...
	AggregateSources(context.Context, dependencies.BranchRequestScope, *AggregateSourcesPayload) (res *AggregationSourcesResult, err error)
}
...
type AggregationSinks []*AggregationSink
...
type AggregationSource struct {
	...
	Deleted  *DeletedEntity
	Disabled *DisabledEntity
	Sinks    AggregationSinks
}

type AggregationSources []*AggregationSource

// AggregationSourcesResult is the result type of the stream service
// AggregateSources method.
type AggregationSourcesResult struct {
	ProjectID ProjectID
	BranchID  BranchID
