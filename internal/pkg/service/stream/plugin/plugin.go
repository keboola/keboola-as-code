...
type Plugins struct {
	...
	sliceUploader       map[stagingModel.FileProvider]uploadSliceFn // func(context.Context, *keboola.FileUploadCredentials, string, ...keboola.UploadOption) (*blob.Writer, error)
}
