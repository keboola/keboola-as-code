...
import (
	...
	"github.com/keboola/keboola-as-code/internal/pkg/service/stream/sink/tablesink/statistics/collector"
	"github.com/keboola/keboola-as-code/internal/pkg/service/stream/sink/tablesink/statistics/repository"
...
type testWriter struct {
	SliceKeyValue         storage.SliceKey
...
func (w *testWriter) SliceKey() storage.SliceKey {
