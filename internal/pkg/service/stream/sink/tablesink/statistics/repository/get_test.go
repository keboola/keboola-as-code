...
func TestRepository_MaxUsedDiskSizeBySliceIn(t *testing.T) {
	...
	// Move statistics to the storage.LevelStaging
	require.NoError(t, repo.Move(sliceKey1, storage.LevelLocal, storage.LevelStaging).Do(ctx).Err())
	require.NoError(t, repo.Move(sliceKey2, storage.LevelLocal, storage.LevelStaging).Do(ctx).Err())
	require.NoError(t, repo.Move(sliceKey3, storage.LevelLocal, storage.LevelStaging).Do(ctx).Err())
	require.NoError(t, repo.Move(sliceKey4, storage.LevelLocal, storage.LevelStaging).Do(ctx).Err())
	require.NoError(t, repo.Move(sliceKey5, storage.LevelLocal, storage.LevelStaging).Do(ctx).Err())
	require.NoError(t, repo.Move(sliceKey6, storage.LevelLocal, storage.LevelStaging).Do(ctx).Err())

	// Move statistics to the storage.LevelTarget
	require.NoError(t, repo.Move(sliceKey2, storage.LevelStaging, storage.LevelTarget).Do(ctx).Err())
	require.NoError(t, repo.Move(sliceKey4, storage.LevelStaging, storage.LevelTarget).Do(ctx).Err())
	require.NoError(t, repo.Move(sliceKey6, storage.LevelStaging, storage.LevelTarget).Do(ctx).Err())
