...
{"level":"debug","message":"synced to revision %d","component":"sink.router"}
{"level":"info","message":"closing sink pipeline \"123/222/my-source-1/my-sink-1\": sink disabled","component":"sink.router"}
