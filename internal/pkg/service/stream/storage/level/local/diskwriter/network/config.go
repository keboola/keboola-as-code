...
type Config struct {
	...
	MinSlicesPerSourceNode int               `configKey:"minSlicesPerSourceNode" configUsage:"Minimum number of slices opened per source node, up to the count of assigned volumes." validate:"required,min=1,max=20"`
