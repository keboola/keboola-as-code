...
type ImportConfig struct {
	MaxSlices   uint64            `json:"maxSlices" configKey:"maxSlices" configUsage:"Max number of slices in a file before an import is triggered, takes precedence over other settings." validate:"required,min=100,max=1000"`
