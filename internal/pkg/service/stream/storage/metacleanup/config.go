...
type Config struct {
	...
	ArchivedFileRetentionPerSink int           `configKey:"archivedFileRetentionPerSink" configMap:"archivedFileRetentionPerSink" configUsage:"Retention period of a file per sink." validate:"required,min=1,max=365"`
