...
func TestMetadataProcessingJobCleanupErrorTolerance(t *testing.T) {
	...
	// Cleanup
	{
		...
		// With Concurrency = 2 and ErrorTolerance = 3, we expect 6 jobs to be attempted
		assert.EventuallyWithT(t, func(c *assert.CollectT) {
			logger.AssertJSONMessages(c, `
{"level":"error","message":"cannot get keboola storage job \"123/456/my-source/my-sink/job%s\":\n- strconv.ParseInt: parsing \"job%s\": invalid syntax"}
{"level":"error","message":"cannot get keboola storage job \"123/456/my-source/my-sink/job%s\":\n- strconv.ParseInt: parsing \"job%s\": invalid syntax"}
{"level":"error","message":"cannot get keboola storage job \"123/456/my-source/my-sink/job%s\":\n- strconv.ParseInt: parsing \"job%s\": invalid syntax"}
{"level":"error","message":"cannot get keboola storage job \"123/456/my-source/my-sink/job%s\":\n- strconv.ParseInt: parsing \"job%s\": invalid syntax"}
{"level":"error","message":"cannot get keboola storage job \"123/456/my-source/my-sink/job%s\":\n- strconv.ParseInt: parsing \"job%s\": invalid syntax"}
