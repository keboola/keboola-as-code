...
import (
	...
	"github.com/keboola/keboola-as-code/internal/pkg/service/stream/storage/repository/token/schema"
...
func NewRepository(d repository.dependencies, all *repository.Repository) *TokenRepository {
