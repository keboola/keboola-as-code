...
type testEvents struct {
	WriterOpen  func(w encoding.Writer) error
	WriterClose func(w encoding.Writer, closeErr error) error
}

func (e *testEvents) OnOpen(fn func(encoding.Writer) error) {
	e.WriterOpen = fn
}

func (e *testEvents) OnClose(fn func(encoding.Writer, error) error) {
	e.WriterClose = fn
}
...
func (w *testWriter) Events() *events.Events[encoding.Writer] {
	panic(errors.New("method should not be called"))
}
