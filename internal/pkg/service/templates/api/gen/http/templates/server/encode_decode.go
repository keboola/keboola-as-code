...
func DecodeRepositoriesIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.RepositoriesIndexPayload, error) {
	return func(r *http.Request) (*templates.RepositoriesIndexPayload, error) {
		var payload *templates.RepositoriesIndexPayload
		var (
...
func DecodeRepositoryIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.RepositoryIndexPayload, error) {
	return func(r *http.Request) (*templates.RepositoryIndexPayload, error) {
		var payload *templates.RepositoryIndexPayload
		var (
			repository      string
			storageAPIToken string
			err             error
...
func DecodeTemplatesIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.TemplatesIndexPayload, error) {
	return func(r *http.Request) (*templates.TemplatesIndexPayload, error) {
		var payload *templates.TemplatesIndexPayload
		var (
			repository      string
			filter          *string
			storageAPIToken string
...
// templates TemplateIndex endpoint.
func DecodeTemplateIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.TemplateIndexPayload, error) {
	return func(r *http.Request) (*templates.TemplateIndexPayload, error) {
		var payload *templates.TemplateIndexPayload
		var (
			repository      string
			template        string
			storageAPIToken string
...
// templates VersionIndex endpoint.
func DecodeVersionIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.VersionIndexPayload, error) {
	return func(r *http.Request) (*templates.VersionIndexPayload, error) {
		var payload *templates.VersionIndexPayload
		var (
			repository      string
			template        string
			version         string
...
// templates InputsIndex endpoint.
func DecodeInputsIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.InputsIndexPayload, error) {
	return func(r *http.Request) (*templates.InputsIndexPayload, error) {
		var payload *templates.InputsIndexPayload
		var (
			repository      string
			template        string
			version         string
...
func DecodeValidateInputsRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.ValidateInputsPayload, error) {
	return func(r *http.Request) (*templates.ValidateInputsPayload, error) {
		var payload *templates.ValidateInputsPayload
		var (
...
func DecodeUseTemplateVersionRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.UseTemplateVersionPayload, error) {
	return func(r *http.Request) (*templates.UseTemplateVersionPayload, error) {
		var payload *templates.UseTemplateVersionPayload
		var (
...
// EncodePreviewResponse returns an encoder for responses returned by the
// templates Preview endpoint.
func EncodePreviewResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*templates.Task)
		enc := encoder(ctx, w)
		body := NewPreviewResponseBody(res)
		w.WriteHeader(http.StatusAccepted)
		return enc.Encode(body)
	}
}

// DecodePreviewRequest returns a decoder for requests sent to the templates
// Preview endpoint.
func DecodePreviewRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.PreviewPayload, error) {
	return func(r *http.Request) (*templates.PreviewPayload, error) {
		var payload *templates.PreviewPayload
		var (
		...
		err = ValidatePreviewRequestBody(&body, []string{"body"})
		if err != nil {
			return payload, err
		}
		...
		payload = NewPreviewPayload(&body, repository, template, version, storageAPIToken)
		if strings.Contains(payload.StorageAPIToken, " ") {
			// Remove authorization scheme prefix (e.g. "Bearer")
			cred := strings.SplitN(payload.StorageAPIToken, " ", 2)[1]
			payload.StorageAPIToken = cred
...
// EncodePreviewError returns an encoder for errors returned by the Preview
// templates endpoint.
func EncodePreviewError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "templates.repositoryNotFound":
			...
			if false { // formatter != nil {
				...
				body = NewPreviewTemplatesRepositoryNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "templates.templateNotFound":
			...
			if false { // formatter != nil {
				...
				body = NewPreviewTemplatesTemplateNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "templates.versionNotFound":
			...
			if false { // formatter != nil {
				...
				body = NewPreviewTemplatesVersionNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "templates.projectLocked":
			...
			if false { // formatter != nil {
				...
				body = NewPreviewTemplatesProjectLockedResponseBody(res)
			}
			w.Header().Set("Retry-After", res.RetryAfter)
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusServiceUnavailable)
		...
		case "InvalidInputs":
			...
			if false { // formatter != nil {
				...
				body = NewPreviewInvalidInputsResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
...
func DecodeInstancesIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.InstancesIndexPayload, error) {
	return func(r *http.Request) (*templates.InstancesIndexPayload, error) {
		var payload *templates.InstancesIndexPayload
		var (
			branch          string
			storageAPIToken string
			err             error
...
// templates InstanceIndex endpoint.
func DecodeInstanceIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.InstanceIndexPayload, error) {
	return func(r *http.Request) (*templates.InstanceIndexPayload, error) {
		var payload *templates.InstanceIndexPayload
		var (
			branch          string
			instanceID      string
			storageAPIToken string
...
func DecodeUpdateInstanceRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.UpdateInstancePayload, error) {
	return func(r *http.Request) (*templates.UpdateInstancePayload, error) {
		var payload *templates.UpdateInstancePayload
		var (
...
func DecodeDeleteInstanceRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.DeleteInstancePayload, error) {
	return func(r *http.Request) (*templates.DeleteInstancePayload, error) {
		var payload *templates.DeleteInstancePayload
		var (
			branch          string
			instanceID      string
			storageAPIToken string
...
func DecodeUpgradeInstanceRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.UpgradeInstancePayload, error) {
	return func(r *http.Request) (*templates.UpgradeInstancePayload, error) {
		var payload *templates.UpgradeInstancePayload
		var (
...
func DecodeUpgradeInstanceInputsIndexRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.UpgradeInstanceInputsIndexPayload, error) {
	return func(r *http.Request) (*templates.UpgradeInstanceInputsIndexPayload, error) {
		var payload *templates.UpgradeInstanceInputsIndexPayload
		var (
			branch          string
			instanceID      string
			version         string
...
func DecodeUpgradeInstanceValidateInputsRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.UpgradeInstanceValidateInputsPayload, error) {
	return func(r *http.Request) (*templates.UpgradeInstanceValidateInputsPayload, error) {
		var payload *templates.UpgradeInstanceValidateInputsPayload
		var (
...
// GetTask endpoint.
func DecodeGetTaskRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*templates.GetTaskPayload, error) {
	return func(r *http.Request) (*templates.GetTaskPayload, error) {
		var payload *templates.GetTaskPayload
		var (
			taskID          string
			storageAPIToken string
			err             error
