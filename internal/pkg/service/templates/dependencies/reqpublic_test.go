...
func TestPublicRequestScope_Components_Cached(t *testing.T) {
	...
	req1Scp := NewPublicRequestScope(apiScp, httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/req1", nil))
	...
	req2Scp := NewPublicRequestScope(apiScp, httptest.NewRequestWithContext(t.Context(), http.MethodGet, "/req2", nil))
