...
func (c loadCtx) loadBranch(branch *model.Branch, pool *client.Pool) {
...
func (c loadCtx) loadConfigsMetadataRequest(branch *model.Branch, pool *client.Pool) (map[model.Key]map[string]string, *client.Request) {
	lock := &sync.Mutex{}
