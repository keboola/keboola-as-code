...
// SingleTracerProvider is a workaround for DataDog OpenTelemetry tracer.
...
func SingleTracerProvider(tracer trace.Tracer) trace.TracerProvider {
	return &singleTracerProvider{tracer: tracer}
}
