...
func TestRules_ValidateValue(t *testing.T) {
	...
	// Valid
	assert.NoError(t, Rules("").ValidateValue(context.Background(), Input{ID: "my-field", Name: "my field"}, "foo bar"))
	assert.NoError(t, Rules("required").ValidateValue(context.Background(), Input{ID: "my-field", Name: "my field"}, "foo bar"))
...
func TestRules_ValidateEmptyObject(t *testing.T) {
	...
	// Valid
	assert.NoError(t, Rules("required").ValidateValue(context.Background(), Input{ID: "my-field", Name: "my field", Type: TypeObject}, map[string]any{"foo": "bar"}))
