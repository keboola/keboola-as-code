...
func MockedComponents() storageapi.Components {
	return storageapi.Components{
		...
		{ComponentKey: storageapi.ComponentKey{ID: "keboola.snowflake-transformation"}, Type: "transformation", Name: "Snowflake", Data: storageapi.ComponentData{}, Flags: []string{"genericCodeBlocksUI"}},
		{ComponentKey: storageapi.ComponentKey{ID: "keboola.python-transformation-v2"}, Type: "transformation", Name: "Python", Data: storageapi.ComponentData{}, Flags: []string{"genericCodeBlocksUI"}},
