...
func Run(ctx context.Context, fs filesystem.Fs, d dependencies) (err error) {
	...
	// .gitignore - to keep ".env.local" local and ignore generated files
	gitIgnoreMsg := ` - to keep ".env.local" local and ignore generated files`
	gitIgnoreLines := []filesystem.FileLine{
		{Line: "/.env.local"},
		{Line: "/.keboola/project.json"},
		{Line: ""},
		{Line: "# Local data directories (generated by kbc local data)"},
		{Line: "**/data/"},
		{Line: ""},
		{Line: "# Python virtual environments and build artifacts"},
		{Line: "**/venv/"},
		{Line: "**/.venv/"},
		{Line: "*.egg-info/"},
		{Line: ""},
