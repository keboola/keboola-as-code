...
if [[ "$CREATE_BUFFER_BENCHMARK" == "true" ]]; then
  ...
  envsubst < templates/benchmark/job-parallel.yaml         > deploy/benchmark/job-parallel.yaml
...
if [[ "$CLOUD_PROVIDER" == "aws" ]]; then
  ...
  envsubst < templates/cloud/aws/storage-class.yaml > deploy/cloud/aws/storage-class.yaml
