...
export STREAM_API_MEMORY_SOFT_LIMIT="${STREAM_API_MEMORY_SOFT_LIMIT:="225Mi"}"
...
export STREAM_HTTP_SOURCE_MEMORY_SOFT_LIMIT="${STREAM_HTTP_SOURCE_MEMORY_SOFT_LIMIT:="3600Mi"}"
...
export STREAM_STORAGE_WRITER_MEMORY_SOFT_LIMIT="${STREAM_STORAGE_WRITER_MEMORY_SOFT_LIMIT:="225Mi"}"
...
export STREAM_STORAGE_READER_MEMORY_SOFT_LIMIT="${STREAM_STORAGE_READER_MEMORY_SOFT_LIMIT:="225Mi"}"
...
# Memory/CPU usage is minimal.
export STREAM_STORAGE_COORDINATOR_MEMORY_SOFT_LIMIT="${STREAM_STORAGE_COORDINATOR_MEMORY_SOFT_LIMIT:="225Mi"}"
