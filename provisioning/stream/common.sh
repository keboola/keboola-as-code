...
export STREAM_ETCD_MEMORY_SOFT_LIMIT="${STREAM_ETCD_MEMORY_SOFT_LIMIT:="1600Mi"}"
export STREAM_ETCD_MEMORY_HARD_LIMIT="${STREAM_ETCD_MEMORY_HARD_LIMIT:="2000Mi"}"
export STREAM_ETCD_CPU_SOFT_LIMIT="${STREAM_ETCD_CPU_SOFT_LIMIT:="4000m"}"
...
export STREAM_API_MEMORY_SOFT_LIMIT="${STREAM_API_MEMORY_SOFT_LIMIT:="200Mi"}"
export STREAM_API_MEMORY_HARD_LIMIT="${STREAM_API_MEMORY_HARD_LIMIT:="250Mi"}"
export STREAM_API_CPU_SOFT_LIMIT="${STREAM_API_CPU_SOFT_LIMIT:="200m"}"
...
export STREAM_HTTP_SOURCE_MEMORY_SOFT_LIMIT="${STREAM_HTTP_SOURCE_MEMORY_SOFT_LIMIT:="3200Mi"}"
export STREAM_HTTP_SOURCE_MEMORY_HARD_LIMIT="${STREAM_HTTP_SOURCE_MEMORY_HARD_LIMIT:="4000Mi"}"
export STREAM_HTTP_SOURCE_CPU_SOFT_LIMIT="${STREAM_HTTP_SOURCE_CPU_SOFT_LIMIT:="4000m"}"
...
export STREAM_STORAGE_WRITER_MEMORY_SOFT_LIMIT="${STREAM_STORAGE_WRITER_MEMORY_SOFT_LIMIT:="200Mi"}"
export STREAM_STORAGE_WRITER_MEMORY_HARD_LIMIT="${STREAM_STORAGE_WRITER_MEMORY_HARD_LIMIT:="250Mi"}"
export STREAM_STORAGE_WRITER_CPU_SOFT_LIMIT="${STREAM_STORAGE_WRITER_CPU_SOFT_LIMIT:="1000m"}"

# Storage reader uploads slices from the local disk to a staging storage.
# Sufficiently disks speed is required.
export STREAM_STORAGE_READER_MEMORY_SOFT_LIMIT="${STREAM_STORAGE_READER_MEMORY_SOFT_LIMIT:="200Mi"}"
export STREAM_STORAGE_READER_MEMORY_HARD_LIMIT="${STREAM_STORAGE_READER_MEMORY_HARD_LIMIT:="250Mi"}"
export STREAM_STORAGE_READER_CPU_SOFT_LIMIT="${STREAM_STORAGE_READER_CPU_SOFT_LIMIT:="500m"}"
...
# Memory/CPU usage is minimal.
export STREAM_STORAGE_COORDINATOR_MEMORY_SOFT_LIMIT="${STREAM_STORAGE_COORDINATOR_MEMORY_SOFT_LIMIT:="500Mi"}"
export STREAM_STORAGE_COORDINATOR_MEMORY_HARD_LIMIT="${STREAM_STORAGE_COORDINATOR_MEMORY_HARD_LIMIT:="750Mi"}"
export STREAM_STORAGE_COORDINATOR_CPU_SOFT_LIMIT="${STREAM_STORAGE_COORDINATOR_CPU_SOFT_LIMIT:="400m"}"

# Constants
export NAMESPACE="stream"
ETCD_HELM_CHART_VERSION="12.0.6"
