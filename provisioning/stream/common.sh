...
# Memory/CPU usage is minimal.
export STREAM_STORAGE_COORDINATOR_MEMORY_SOFT_LIMIT="${STREAM_STORAGE_COORDINATOR_MEMORY_SOFT_LIMIT:="200Mi"}"
export STREAM_STORAGE_COORDINATOR_MEMORY_HARD_LIMIT="${STREAM_STORAGE_COORDINATOR_MEMORY_HARD_LIMIT:="250Mi"}"
export STREAM_STORAGE_COORDINATOR_CPU_SOFT_LIMIT="${STREAM_STORAGE_COORDINATOR_CPU_SOFT_LIMIT:="200m"}"
