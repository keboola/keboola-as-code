...
kubectl -n $NAMESPACE label pod templates-api-etcd-0 app.kubernetes.io/component=etcd
kubectl -n $NAMESPACE label pod templates-api-etcd-1 app.kubernetes.io/component=etcd
kubectl -n $NAMESPACE label pod templates-api-etcd-2 app.kubernetes.io/component=etcd
kubectl -n $NAMESPACE delete statefulset templates-api-etcd --cascade=orphan
