...
func (a *StorageApi) GetConfig(branchId int, componentId string, configId string) (*remote.Config, error) {
	response := a.GetConfigRequest(branchId, componentId, configId).Send().Response()
	if response.HasResult() {
		return response.Result().(*remote.Config), nil
	}
	return nil, response.Error()
}

func (a *StorageApi) CreateConfig(config *remote.Config) (*remote.Config, error) {
...
func (a *StorageApi) UpdateConfig(config *remote.Config) (*remote.Config, error) {
...
func (a *StorageApi) CreateConfigRequest(config *remote.Config) (*client.Request, error) {
	// Id is autogenerated
	if config.Id != "" {
...
func (a *StorageApi) UpdateConfigRequest(config *remote.Config) (*client.Request, error) {
	// Id is required
	if config.Id == "" {
	...
	rowsSortOrderJson, err := json.Marshal(rowsSortOrder)
	if err != nil {
